...
## (2) Detect circles
	...
	# 		# Drawing a rectangle on c
		...
		# full_img_path="./static/{}/full_image.png".format(ID)
		...
		# print("word1",word)
		msg = {'id':ID,'number': result_str, 'crop_image': crp_url, 'full_image': full_img_path}
		sql = "INSERT INTO Wheels (ID,WheelNoL,WheelNoR,Hardness,CropImgL,CropImgR,FullImg,TestID ) VALUES (%s, %s,%s,%s,%s,%s)"
		val=(ID,word,word1,"0",crp_urlL,crp_urlR,full_img_path,"343c0b3f-b9a6-470b-8d53-d097925e2ec5")
		mycursor.execute(sql, val)

		mydb.commit()
		# image = load_image("new2.jpg", xp, image_size)
		# with configuration.using_config('train', False):
		# 	predictions, crops, grids = network(image[xp.newaxis, ...])
		...
		# word1= strip_prediction(classification, xp,blank_symbol)[0]

		# word1 = "".join(map(lambda x: chr(char_map[str(x)]), word))
