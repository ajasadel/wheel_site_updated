...
while True:
	...
	## (2) Detect circles
		...
		# 		# Drawing a rectangle on c
			...
			#cv2.imshow("",croped)
			dst = cv2.warpPolar(croped, (int(h*3.5),int(w*3)),(191,175),210, flags=(cv2.WARP_POLAR_LOG))
			dst1 = cv2.warpPolar(croped1, (int(h*3.5),int(w*3)),(191,175),210, flags=(cv2.WARP_POLAR_LOG))
			...
			img_path="{}/full_image{}.jpg".format(full_img_path,time_stamp)

			rotated_img_path="{}/rotated{}.jpg".format(full_img_path,time_stamp)
			rotated_img_path1="{}/rotated1{}.jpg".format(full_img_path,time_stamp)
			...
			mydb.commit()
			msg = {'id':ID,'wheelNoL': wheelIDL, 'wheelNoR': wheelIDR, 'CropImgL': crp_urlL,'CropImgR':crp_urlR,}
			print(msg)
